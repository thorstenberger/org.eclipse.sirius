...
public class SemanticPartitionInvalidator {
    ...
    public java.util.Optional<EvaluatedSemanticPartition> hasFastResult(EObject sourceElement, SemanticPartition semanticPartition, CreatedOutput parentElement) {
