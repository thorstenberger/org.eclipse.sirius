...
public class SiriusJPSRenderedDiagramPrinter extends JPSDiagramPrinter {
    ...
    public int printPreviousLuna(Graphics printGraphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        java.util.Optional<Object> optionPages = ReflectionHelper.getFieldValueWithoutException(this, "pages"); //$NON-NLS-1$
    ...
    private class PrinterGraphicsToGraphics2DAdapter extends GraphicsToGraphics2DAdaptor {
        ...
        public void drawString(String s, int x, int y) {
            java.util.Optional<Object> optionalTransX = ReflectionHelper.getFieldValueWithoutException(this, "transX"); //$NON-NLS-1$
            java.util.Optional<Object> optionalTransY = ReflectionHelper.getFieldValueWithoutException(this, "transY"); //$NON-NLS-1$
