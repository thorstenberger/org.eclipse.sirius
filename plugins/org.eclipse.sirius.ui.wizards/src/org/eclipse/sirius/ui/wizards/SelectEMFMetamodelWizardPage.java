...
public class SelectEMFMetamodelWizardPage extends WizardPage {
    ...
    private void createMetamodelFilterText(Composite parent) {
        ...
        this.metamodelFilterText.addKeyListener(new KeyListener() {
            @Override
    ...
    private void createMetamodelFilteredList(Composite parent) {
        ...
        this.metamodelFilteredList.addSelectionListener(new SelectionListener() {
            @Override
    ...
    private void createMetamodelDocumentation(Composite parent) {
        ...
        this.documentationBrowser = new Browser(parent, SWT.NONE);
        this.documentationBrowser.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
    }
    ...
    private String getDocumentation(EPackage ePackage) {
        ...
        if (documentation == null) {
            documentation = ePackage.getNsURI();
        }
