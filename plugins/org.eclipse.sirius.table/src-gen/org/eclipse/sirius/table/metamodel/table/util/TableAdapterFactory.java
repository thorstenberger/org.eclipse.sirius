...
public class TableAdapterFactory extends AdapterFactoryImpl {
    ...
    protected TableSwitch<Adapter> modelSwitch = new TableSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseDTableElementSynchronizer(DTableElementSynchronizer object) {
            return createDTableElementSynchronizerAdapter();
        }
     ...
     * <em>DTable Element</em>}'. <!-- begin-user-doc --> This default
     ...
     * <em>Line Container</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
     ...
     * <em>DCell Style</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
     ...
     * <em>DTarget Column</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
     ...
     * <em>DFeature Column</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
     ...
     * <em>DTable Element Style</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
