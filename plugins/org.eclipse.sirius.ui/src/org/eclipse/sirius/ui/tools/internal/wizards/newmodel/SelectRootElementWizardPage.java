...
public class SelectRootElementWizardPage extends WizardPage implements PropertyChangeListener {
    ...
    private void createRootElementFilterText(Composite parent) {
        ...
        this.rootElementText.addKeyListener(new KeyListener() {
            @Override
    ...
    private void createRootElementCheckbox(Composite parent) {
        ...
        this.rootElementCheckbox.addSelectionListener(new SelectionListener() {
    ...
    private void createRootElementFilteredList(Composite parent) {
        ...
        this.rootElementFilteredList.addSelectionListener(new SelectionListener() {
            @Override
            public void widgetDefaultSelected(SelectionEvent e) {
            }
    ...
    private Collection<EClass> getFilteredConcreteClasses(EPackage ePackage) {
            ...
            if (filteredConcreteClasses.contains(eClass)) {
                ...
                for (EReference eReference : eAllReferences) {
                    if (eReference.isContainment()) {
                        ...
                        if (concreteClasses.contains(eType)) {
        ...
        EClass preferredRootElement = getPreferredRootElementFromEPackageExtraData(ePackage);
        if (preferredRootElement != null) {
            filteredConcreteClasses.add(preferredRootElement);
        }
     ...
     */
    private static class RootElementsListLabelProvider extends LabelProvider {
        ...
        public Image getImage(Object element) {
            return ExtendedImageRegistry.getInstance().getImage(EcoreEditPlugin.INSTANCE.getImage("full/obj16/EClass")); //$NON-NLS-1$
        }
    }
