...
une migration prévue pour Sirius X.Y.Z et pushée à la date T doit avoir (X+7).Y.Z.T, avec T étant la date où le changement est *mergé* dans le code source de Sirius (et pas seulement la date où le commit initial a été créé)
