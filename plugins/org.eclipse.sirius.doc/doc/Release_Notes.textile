...
* <span class="label label-danger">Removed</span> The interface @org.eclipse.sirius.common.tools.api.interpreter.IInterpreterWithDiagnostic@ has been removed. Its single @evaluateExpression()@ method has been moved directly into the general @org.eclipse.sirius.common.tools.api.interpreter.IInterpreter@ interface, and the @IEvaluationResult@ internal type it defined has been made a top-level type @org.eclipse.sirius.common.tools.api.interpreter.IEvaluationResult@ with a default implementation in @org.eclipse.sirius.common.tools.api.interpreter.EvaluationResult@.
