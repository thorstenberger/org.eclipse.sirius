...
* <span class="label label-danger">Removed</span> The interface @org.eclipse.sirius.common.tools.api.interpreter.IInterpreterWithDiagnostic@ has been removed. Its API (a single @evaluateExpression()@ method and an internal @IEvaluationResult@) have been moved directly into the general @org.eclipse.sirius.common.tools.api.interpreter.IInterpreter@ interface.
* <span class="label label-danger">Removed</span> The method @org.eclipse.sirius.common.tools.api.interpreter.IInterpreterContext.getTargetTypes()@, which was deprecated and not usedanywhere in Sirius itself, has been removed. 
