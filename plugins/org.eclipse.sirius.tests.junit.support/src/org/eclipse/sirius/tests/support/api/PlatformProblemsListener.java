...
public class PlatformProblemsListener {
     ...
     * The reported errors.
     */
    private final Multimap<String, IStatus> errors = LinkedHashMultimap.create();

    /**
     * The reported warnings.
     */
    private final Multimap<String, IStatus> warnings = LinkedHashMultimap.create();
    ...
    public Collection<IStatus> getErros() {
        return ImmutableList.copyOf(errors.values());
    }

    public Collection<IStatus> getWarnings() {
     ...
     *            The status to convert
     */
    public void appendStackTrace(StringBuilder stringBuilder, String endLineDelimiter, IStatus status) {
        PrintWriter pw = null;
